...
class VolunteerRegs extends StatelessWidget {
  ...
  final TextEditingController projectData = TextEditingController();
  ...
  void uploadVolunteerData(BuildContext context) async {
    await _firestore.collection("volunteerdata").doc(emailData.text).set({
      "First Name": firstNameData.text,
      "Last Name": lastNameData.text,
      "Date of Birth": dobData.text,
      "age": ageData.text,
